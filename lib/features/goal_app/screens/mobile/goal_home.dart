...
class GoalHome extends StatelessWidget {
      ...
      child: BlocBuilder<GoalBloc, GoalState>(
        builder: (context, state) {
          if (state is GoalLoading) {
            ...
            return _buildFullGoalUI(context,state.generatedGoals, state.personalGoals);
          }
  ...
  // Widget _buildFullGoalUI(List<Goal> generatedGoals, List<Goal> personalGoals) {
    Widget _buildFullGoalUI(BuildContext context, List<Goal> generatedGoals, List<Goal> personalGoals) {
